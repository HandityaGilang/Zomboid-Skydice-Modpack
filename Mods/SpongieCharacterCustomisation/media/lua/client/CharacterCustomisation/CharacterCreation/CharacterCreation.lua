...
function CharacterCreationMain:createCharacterCustomisationWindow()
    ...
    -- self.offsetX = CharacterCreationHeader.instance.avatarPanel:getRight() + 24 + 70;
    self.offsetX = self.skinColorButton.x + 70
    self.offsetY = self.skinColorButton.y

	--create the button that will open the menu
	self.customisationButton = ISButton:new(self.offsetX, self.offsetY, 100, BUTTON_HGT, getText("UI_characreation_appearance"), self, showMenu)
	-- self.customisationButton:setFont(UIFont.Medium)
