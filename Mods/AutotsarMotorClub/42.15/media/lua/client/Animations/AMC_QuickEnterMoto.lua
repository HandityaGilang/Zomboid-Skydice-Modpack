    ...
    if key == getCore():getKey("Interact") then
        ...
        if vehicle then 
            ...
            if conf then
                ...
                if conftable and conftable.quickEnter == "1" and vehicle:isEnterBlocked(playerObj, 0) and vehicle:isEnterBlocked(playerObj, 1) then
                    ...
                    --print('OnAMCConfig not blocked ', tostring(vehicle:isEnterBlocked(playerObj, 0)), tostring(vehicle:isEnterBlocked(playerObj, 1)))
                end
            end
        end
    end
