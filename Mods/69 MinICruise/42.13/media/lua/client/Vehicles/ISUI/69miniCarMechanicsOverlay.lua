...
DAMN.MechOverlay:addParts({
    ["Base.69mini"] = "69mini_",
    ["Base.69miniMrB"] = "69mini_",
    ["Base.69miniIJ"] = "69mini_",
    ["Base.69miniPS"] = "69mini_",
    ["Base.69miniUnionJack"] = "69mini_",
    ["Base.69minICruise"] = "69minICruise_",
}, {
    ...
    --
    DoorFrontLeft = {img="door_front_left", x=79,y=253,x2=85,y2=332},
    DoorFrontRight = {img="door_front_right", x=198,y=253,x2=204,y2=332},
    --
    Engine = {img="engine", x=141,y=176,x2=179,y2=238},
    --
    EngineDoor = {img="hood", x=105,y=176,x2=141,y2=238},
    --
    TrunkDoor = {img="trunk", x=96,y=428,x2=186,y2=440},
    --
    WindowFrontLeft = {img="window_front_left", x=85,y=276,x2=94,y2=332},
    WindowFrontRight = {img="window_front_right", x=189,y=276,x2=198,y2=332},
    --
    Windshield = {img="window_windshield", x=90,y=244,x2=190,y2=271},
    WindshieldRear = {img="window_rear_windshield", x=90,y=406,x2=190,y2=426},
    --
    GasTank = {img="gastank", x=212,y=527,x2=270,y2=565},
    --
    ...
    DAMNRearLeftArmor = {img="armor_doorrl", x=13,y=310,x2=55,y2=346},
    DAMNRearRightArmor = {img="armor_doorrr", x=228,y=310,x2=270,y2=346},
