...
DAMN.MechOverlay:addParts({
    ["Base.82porsche911turbo"] = "82porsche911_",
    ["Base.82porsche911rwb"] = "82porsche911_",
    ["Base.82porsche911sc"] = "82porsche911_",
}, {
    Battery = {img="battery", x=228,y=317,x2=270,y2=348},
    --
    HeadlightLeft = {img="headlight_left", x=79,y=143,x2=99,y2=156},
    HeadlightRight = {img="headlight_right", x=182,y=143,x2=202,y2=156},
    --
    ...
    --
    DoorFrontLeft = {img="door_front_left", x=72,y=264,x2=82,y2=350},
    DoorFrontRight = {img="door_front_right", x=200,y=264,x2=210,y2=350},
    --
    Engine = {img="engine", x=204,y=528,x2=269,y2=568},
    --
    EngineDoor = {img="hood", x=102,y=429,x2=179,y2=480},
    --
    TrunkDoor = {img="trunk", x=100,y=135,x2=182,y2=245},
    --
    WindowFrontLeft = {img="window_front_left", x=82,y=295,x2=93,y2=355},
    WindowFrontRight = {img="window_front_right", x=190,y=295,x2=200,y2=355},
    --
    Windshield = {img="window_windshield", x=93,y=248,x2=190,y2=295},
    WindshieldRear = {img="window_rear_windshield", x=99,y=375,x2=183,y2=428},
    --
...
--
DAMN.MechOverlay:addParts({
    ["Base.82porsche911targa"] = "82porsche911targa_",
}, {
    Battery = {img="battery", x=228,y=317,x2=270,y2=348},
    --
    HeadlightLeft = {img="headlight_left", x=79,y=143,x2=99,y2=156},
