...
CleanUI_Vanilla_ISInventoryPage = ISPanel:derive("CleanUI_Vanilla_ISInventoryPage");

local FONT_HGT_SMALL = getTextManager():getFontHeight(UIFont.Small)
local BUTTON_HGT = FONT_HGT_SMALL + 6
local MAXIMUM_RENAME_LENGTH = 28

CleanUI_Vanilla_ISInventoryPage.bagSoundDelay = 0.5
CleanUI_Vanilla_ISInventoryPage.bagSoundTime = 0

-----

CleanUI_Vanilla_ISInventoryPageContainerButtonPanel = ISPanel:derive("CleanUI_Vanilla_ISInventoryPageContainerButtonPanel")

function CleanUI_Vanilla_ISInventoryPageContainerButtonPanel:prerender()
    ISPanel.prerender(self)
    self:setStencilRect(0, 0, self.width, self.height)
end

function CleanUI_Vanilla_ISInventoryPageContainerButtonPanel:render()
    ISPanel.render(self)
    self:clearStencilRect()
    self:repaintStencilRect(0, 0, self.width, self.height)
end

function CleanUI_Vanilla_ISInventoryPageContainerButtonPanel:keepSelectedButtonVisible()
...
function CleanUI_Vanilla_ISInventoryPageContainerButtonPanel:new(x, y, w, h)
...
--************************************************************************--
--** CleanUI_Vanilla_ISInventoryPage:initialise
--**
--************************************************************************--

function CleanUI_Vanilla_ISInventoryPage:initialise()
	ISPanel.initialise(self);
end

function CleanUI_Vanilla_ISInventoryPage:onChangeFilter(selected)

end

function CleanUI_Vanilla_ISInventoryPage:titleBarHeight(selected)
...
function CleanUI_Vanilla_ISInventoryPage:createChildren()
	...
	-- FIXME: It is wrong to have both self.transferAll and CleanUI_Vanilla_ISInventoryPage.transferAll (button and function with the same name).
...
--[[
    ...
    self.transferAll = ISButton:new(self.width - 1 - buttonHeight - buttonOffset - weightWid - textButtonOffset - textWid, 0, textWid, buttonHeight, getText("IGUI_invpage_Transfer_all"), self, CleanUI_Vanilla_ISInventoryPage.transferAll);
    ...
    if self.onCharacter then
        ...
        self.lootAll = ISButton:new(1 + (buttonHeight+buttonOffset)*2, 1, 50, buttonHeight, getText("IGUI_invpage_Loot_all"), self, CleanUI_Vanilla_ISInventoryPage.lootAll);
...
--
--         self.removeAll = ISButton:new(self.lootAll:getRight() + textButtonOffset, 1, 50, buttonHeight, getText("IGUI_invpage_RemoveAll"), self, CleanUI_Vanilla_ISInventoryPage.removeAll);
...
--         self.toggleStove = ISButton:new(self.lootAll:getRight() + textButtonOffset, 1, 50, buttonHeight, getText("ContextMenu_Turn_On"), self, CleanUI_Vanilla_ISInventoryPage.toggleStove);
...
--         self.closeTrunk = ISButton:new(self.lootAll:getRight() + textButtonOffset, 1, 50, buttonHeight, getText("IGUI_CloseTrunk"), self, CleanUI_Vanilla_ISInventoryPage.closeTrunk);
...
--
--         self.lockTrunk = ISButton:new(self.closeTrunk:getRight() + textButtonOffset, 1, 50, buttonHeight, getText("IGUI_LockTrunk"), self, CleanUI_Vanilla_ISInventoryPage.lockTrunk);
...
--
--         self.switchOutfit = ISButton:new(self.lootAll:getRight() + textButtonOffset, 1, 50, buttonHeight, getText("ContextMenu_SwitchOutfit"), self, CleanUI_Vanilla_ISInventoryPage.switchOutfit);
...
--
--         self.wearAll = ISButton:new(self.switchOutfit:getRight() + textButtonOffset, 1, 50, buttonHeight, getText("ContextMenu_WearAll"), self, CleanUI_Vanilla_ISInventoryPage.wearAll);
...
--
--         self.propaneTileToggle = ISButton:new(self.lootAll:getRight() + textButtonOffset, 1, 50, buttonHeight, getText("ContextMenu_Turn_On"), self, CleanUI_Vanilla_ISInventoryPage.togglePropaneTile);
...
--
--         self.removePropaneTileTank = ISButton:new(self.propaneTileToggle:getRight() + textButtonOffset, 1, 50, buttonHeight, getText("ContextMenu_Remove_Propane_Tank"), self, CleanUI_Vanilla_ISInventoryPage.removePropaneTileTank);
...
--
--         self.addPropaneTileTank = ISButton:new(self.propaneTileToggle:getRight() + textButtonOffset, 1, 50, buttonHeight, getText("ContextMenu_Insert_Propane_Tank"), self, CleanUI_Vanilla_ISInventoryPage.addPropaneTileTank);
...
--
--         self.addFuel = ISButton:new(self.lootAll:getRight() + textButtonOffset, 1, 50, buttonHeight, getText("ContextMenu_DestroyForFuel"), self, CleanUI_Vanilla_ISInventoryPage.addFuelOption);
...
--
--         self.putOut = ISButton:new(self.addFuel:getRight() + textButtonOffset, 1, 50, buttonHeight, getText("ContextMenu_Put_out_fire"), self, CleanUI_Vanilla_ISInventoryPage.putOut);
...
--
--         self.lightFire = ISButton:new(self.addFuel:getRight() + textButtonOffset, 1, 50, buttonHeight, getText("ContextMenu_Light_fire"), self, CleanUI_Vanilla_ISInventoryPage.lightFireOption);
...
--         self.lightFire:setVisible(false);
    ...
    self.containerButtonPanel = CleanUI_Vanilla_ISInventoryPageContainerButtonPanel:new(self.width - self.buttonSize, titleBarHeight, self.buttonSize, self.inventoryPane.height)
    ...
    --	local filter = ISRadioOption:new(0, 15, 150, 150, "Filter", self, CleanUI_Vanilla_ISInventoryPage.onChangeFilter);
...
--	self:addChild(filter);
    ...
    self.closeButton = ISButton:new(1, 1, buttonHeight, buttonHeight, "", self, CleanUI_Vanilla_ISInventoryPage.close);
    ...
    self.infoButton = ISButton:new(1 + buttonHeight + buttonOffset, 1, buttonHeight, buttonHeight, "", self, CleanUI_Vanilla_ISInventoryPage.onInfo);
    ...
    self.pinButton = ISButton:new(self.width - 1 - buttonHeight, 1, buttonHeight, buttonHeight, "", self, CleanUI_Vanilla_ISInventoryPage.setPinned);
  ...
  --  --print("set pin button invisible.");
   ...
   -- --print("adding collapse button");
    self.collapseButton = ISButton:new(self.pinButton:getX(), 1, buttonHeight, buttonHeight, "", self, CleanUI_Vanilla_ISInventoryPage.collapse);
	...
	self.totalWeight = CleanUI_Vanilla_ISInventoryPage.loadWeight(self.inventory);
	self.totalItems = 0;
...
function CleanUI_Vanilla_ISInventoryPage:updateItemCount()
    self.totalItems = luautils.countItemsRecursive({luautils.findRootInventory(self.inventoryPane.inventory)});
end

function CleanUI_Vanilla_ISInventoryPage:refreshWeight()
	return;
--~ 	for i,v in ipairs(self.backpacks) do
--~ 		v:setOverlayText(CleanUI_Vanilla_ISInventoryPage.loadWeight(v.inventory) .. "/" .. v.capacity);
--~ 	end
end

function CleanUI_Vanilla_ISInventoryPage:lootAll()
    self.inventoryPane:lootAll();
end

function CleanUI_Vanilla_ISInventoryPage:transferAll()
    self.inventoryPane:transferAll();
end


local function CleanUI_canAccessVehicleContainer(vehicle, partIndex, playerObj, itemContainer)
    -- Keep UI refresh safe if vanilla or another mod throws while testing vehicle container access.
    if not vehicle or not playerObj then
        return false
    end

    local ok, result = pcall(function()
        return vehicle:canAccessContainer(partIndex, playerObj)
    end)
    if ok then
        return result == true
    end

    -- Fallback to the lighter character/container access check instead of breaking the inventory UI.
    if itemContainer then
        local okFallback, fallbackResult = pcall(function()
            return playerObj:canAccessContainer(itemContainer)
        end)
        if okFallback then
...
function CleanUI_Vanilla_ISInventoryPage:toggleStove()
...
-- function CleanUI_Vanilla_ISInventoryPage:closeTrunk()
-- 	if UIManager.getSpeedControls() and UIManager.getSpeedControls():getCurrentGameSpeed() == 0 then
-- 		return
-- 	end
--
...
-- end
--
-- function CleanUI_Vanilla_ISInventoryPage:lockTrunk()
-- 	if UIManager.getSpeedControls() and UIManager.getSpeedControls():getCurrentGameSpeed() == 0 then
-- 		return
-- 	end
--
...
-- end
--
-- function CleanUI_Vanilla_ISInventoryPage:switchOutfit()
-- 	if UIManager.getSpeedControls() and UIManager.getSpeedControls():getCurrentGameSpeed() == 0 then
-- 		return
-- 	end
--
...
-- end
--
-- function CleanUI_Vanilla_ISInventoryPage:displayFireTileInfo()
-- 	if UIManager.getSpeedControls() and UIManager.getSpeedControls():getCurrentGameSpeed() == 0 then
-- 		return
-- 	end
--
...
-- end
--
-- function CleanUI_Vanilla_ISInventoryPage:togglePropaneTile()
-- 	if UIManager.getSpeedControls() and UIManager.getSpeedControls():getCurrentGameSpeed() == 0 then
-- 		return
-- 	end
--
...
-- end
--
-- function CleanUI_Vanilla_ISInventoryPage:addPropaneTileTank()
-- 	if UIManager.getSpeedControls() and UIManager.getSpeedControls():getCurrentGameSpeed() == 0 then
-- 		return
-- 	end
--
...
-- end
--
-- function CleanUI_Vanilla_ISInventoryPage:removePropaneTileTank()
-- 	if UIManager.getSpeedControls() and UIManager.getSpeedControls():getCurrentGameSpeed() == 0 then
-- 		return
-- 	end
--
...
-- function CleanUI_Vanilla_ISInventoryPage:addFuelOption()
-- 	if UIManager.getSpeedControls() and UIManager.getSpeedControls():getCurrentGameSpeed() == 0 then
-- 		return
-- 	end
--
...
-- end
--
-- function CleanUI_Vanilla_ISInventoryPage:putOut()
-- 	if UIManager.getSpeedControls() and UIManager.getSpeedControls():getCurrentGameSpeed() == 0 then
-- 		return
-- 	end
--
...
-- end
--
-- function CleanUI_Vanilla_ISInventoryPage:lightFireOption()
-- 	if UIManager.getSpeedControls() and UIManager.getSpeedControls():getCurrentGameSpeed() == 0 then
-- 		return
-- 	end
--
...
-- function CleanUI_Vanilla_ISInventoryPage:wearAll()
-- 	if UIManager.getSpeedControls() and UIManager.getSpeedControls():getCurrentGameSpeed() == 0 then
-- 		return
-- 	end
--
...
-- function CleanUI_Vanilla_ISInventoryPage:syncToggleStove()
...
-- function CleanUI_Vanilla_ISInventoryPage:syncCloseTrunk()
-- 	if self.onCharacter then return end
...
-- end
--
-- function CleanUI_Vanilla_ISInventoryPage:syncLockTrunk()
-- 	if self.onCharacter then return end
...
-- end
--
-- function CleanUI_Vanilla_ISInventoryPage:syncSwitchOutfit()
-- 	if self.onCharacter then return end
...
-- end
--
-- function CleanUI_Vanilla_ISInventoryPage:syncWearAll()
-- 	if self.onCharacter then return end
...
-- end
--
-- function CleanUI_Vanilla_ISInventoryPage:syncPropaneTileToggle()
-- 	if self.onCharacter then return end
...
-- end
--
-- function CleanUI_Vanilla_ISInventoryPage:syncRemovePropaneTileTank()
-- 	if self.onCharacter then return end
...
-- end
--
-- function CleanUI_Vanilla_ISInventoryPage:syncAddPropaneTileTank()
-- 	if self.onCharacter then return end
...
-- end
--
function CleanUI_Vanilla_ISInventoryPage:syncAddFuel()
	if self.onCharacter then return end
...
function CleanUI_Vanilla_ISInventoryPage:syncPutOut()
	if self.onCharacter then return end
...
function CleanUI_Vanilla_ISInventoryPage:syncLightFire()
	if self.onCharacter then return end
...
function CleanUI_Vanilla_ISInventoryPage:setInfo(text)
    self.infoButton:setVisible(true);
    self.infoText = text;
end

function CleanUI_Vanilla_ISInventoryPage:onInfo()
...
function CleanUI_Vanilla_ISInventoryPage:collapse()
...
function CleanUI_Vanilla_ISInventoryPage:setPinned()
    self.pin = true;
...
function CleanUI_Vanilla_ISInventoryPage:isRemoveButtonVisible()
...
function CleanUI_Vanilla_ISInventoryPage.OnObjectHighlighted(playerNum, object, isHighlighted)
...
function CleanUI_Vanilla_ISInventoryPage:getContainerParent(container)
...
function CleanUI_Vanilla_ISInventoryPage:updateContainerHighlight()
...
function CleanUI_Vanilla_ISInventoryPage:update()
    local playerObj = getSpecificPlayer(self.player)
...
function CleanUI_Vanilla_ISInventoryPage:setBlinkingContainer(blinking, containerType)
	if blinking then
...
function CleanUI_Vanilla_ISInventoryPage:setForceSelectedContainer(container, ms)
	self.forceSelectedContainer = container
	self.forceSelectedContainerTime = getTimestampMs() + (ms or 1000)
end

--************************************************************************--
--** CleanUI_Vanilla_ISInventoryPage:prerender
--**
--************************************************************************--
function CleanUI_Vanilla_ISInventoryPage:prerender()
...
--~ 	end
	...
	-- load the current weight of the container
	self.totalWeight = CleanUI_Vanilla_ISInventoryPage.loadWeight(self.inventoryPane.inventory);
...
--                 end
    ...
    if playerObj and playerObj:isInvPageDirty() then
        ...
        CleanUI_Vanilla_ISInventoryPage.renderDirty = false;
        CleanUI_Vanilla_ISInventoryPage.dirtyUI();
    end
    if CleanUI_Vanilla_ISInventoryPage.renderDirty then
        CleanUI_Vanilla_ISInventoryPage.renderDirty = false;
        CleanUI_Vanilla_ISInventoryPage.dirtyUI();
    end
end

function CleanUI_Vanilla_ISInventoryPage:drawTextRight(str, x, y, r, g, b, a, font)
...
function CleanUI_Vanilla_ISInventoryPage:drawText(str, x, y, r, g, b, a, font)
...
function CleanUI_Vanilla_ISInventoryPage:close()
	ISPanel.close(self)
...
function CleanUI_Vanilla_ISInventoryPage:onToggleVisible()
    self.inventoryPane:clearWorldObjectHighlights();
end

function CleanUI_Vanilla_ISInventoryPage:onLoseJoypadFocus(joypadData)
...
function CleanUI_Vanilla_ISInventoryPage:onGainJoypadFocus(joypadData)
...
function CleanUI_Vanilla_ISInventoryPage:getCurrentBackpackIndex()
...
function CleanUI_Vanilla_ISInventoryPage:prevUnlockedContainer(index, wrap)
    local playerObj = getSpecificPlayer(self.player)
...
function CleanUI_Vanilla_ISInventoryPage:nextUnlockedContainer(index, wrap)
...
function CleanUI_Vanilla_ISInventoryPage:selectPrevContainer()
    local currentIndex = self:getCurrentBackpackIndex()
...
function CleanUI_Vanilla_ISInventoryPage:selectNextContainer()
    local currentIndex = self:getCurrentBackpackIndex()
...
function CleanUI_Vanilla_ISInventoryPage:onJoypadDown(button)
...
function CleanUI_Vanilla_ISInventoryPage:onJoypadDirUp(joypadData)
    local shoulderSwitch = getCore():getOptionShoulderButtonContainerSwitch()
...
function CleanUI_Vanilla_ISInventoryPage:onJoypadDirDown(joypadData)
    local shoulderSwitch = getCore():getOptionShoulderButtonContainerSwitch()
    if shoulderSwitch == 3 then
        if isJoypadPressed(joypadData.id, Joypad.LBumper) then
            getPlayerInventory(self.player):selectNextContainer()
...
function CleanUI_Vanilla_ISInventoryPage:ensureVisible(index)
...
function CleanUI_Vanilla_ISInventoryPage:onJoypadDirLeft()
    local inv = getPlayerInventory(self.player);
    local loot = getPlayerLoot(self.player);
...
function CleanUI_Vanilla_ISInventoryPage:onJoypadDirRight()
    local inv = getPlayerInventory(self.player);
    local loot = getPlayerLoot(self.player);
...
function CleanUI_Vanilla_ISInventoryPage:render()
	local titleBarHeight = self:titleBarHeight()
...
function CleanUI_Vanilla_ISInventoryPage:dropItemsInContainer(button)
...
function CleanUI_Vanilla_ISInventoryPage:playContainerOpenCloseSounds(button)
    if button.inventory ~= self.inventoryPane.lastinventory then
        if button.inventory:getOpenSound() then
            if CleanUI_Vanilla_ISInventoryPage.bagSoundTime + CleanUI_Vanilla_ISInventoryPage.bagSoundDelay < getTimestamp() then
                local eventInstance = getSpecificPlayer(self.player):playSound(button.inventory:getOpenSound())
                if eventInstance ~= 0 then
                    CleanUI_Vanilla_ISInventoryPage.bagSoundTime = getTimestamp()
...
function CleanUI_Vanilla_ISInventoryPage:playContainerOpenSound(container)
...
function CleanUI_Vanilla_ISInventoryPage:playContainerCloseSound(container)
    if not container then return end
    if self.onCharacter then return false end
    if isGamePaused() then return false end
...
function CleanUI_Vanilla_ISInventoryPage:updateContainerOpenCloseSounds()
    if self.onCharacter then return end
...
function CleanUI_Vanilla_ISInventoryPage:selectContainer(button)
	local playerObj = getSpecificPlayer(self.player)
...
function CleanUI_Vanilla_ISInventoryPage:setNewContainer(inventory)
...
function CleanUI_Vanilla_ISInventoryPage:selectButtonForContainer(container)
...
function CleanUI_Vanilla_ISInventoryPage.loadWeight(inv)
...
--**
--************************************************************************--
function CleanUI_Vanilla_ISInventoryPage:onMouseMove(dx, dy)
	self.mouseOver = true;
...
--**
--************************************************************************--
function CleanUI_Vanilla_ISInventoryPage:onMouseMoveOutside(dx, dy)
...
--**
--************************************************************************--
function CleanUI_Vanilla_ISInventoryPage:onMouseUp(x, y)
...
function CleanUI_Vanilla_ISInventoryPage:onMouseDown(x, y)
...
function CleanUI_Vanilla_ISInventoryPage:onRightMouseDownOutside(x, y)
...
function CleanUI_Vanilla_ISInventoryPage:onMouseDownOutside(x, y)
    if((self:getMouseX() < 0 or self:getMouseY() < 0 or self:getMouseX() > self:getWidth() or self:getMouseY() > self:getHeight()) and  not self.pin) then
        self:collapseNow()
    end
end

function CleanUI_Vanilla_ISInventoryPage:onMouseUpOutside(x, y)
	if not self:getIsVisible() then
		return;
	end
...
function CleanUI_Vanilla_ISInventoryPage:collapseNow()
    if self.isCollapsed then return end
    self.isCollapsed = true
    self:setMaxDrawHeight(self:titleBarHeight())
end

function CleanUI_Vanilla_ISInventoryPage:isCycleContainerKeyDown()
...
function CleanUI_Vanilla_ISInventoryPage:onMouseWheel(del)
...
CleanUI_Vanilla_ISInventoryPage.dirtyUI = function ()
   -- CleanUI_Vanilla_ISInventoryPage.playerInventory.inventoryPane:refreshContainer();
...
function CleanUI_Vanilla_ISInventoryPage:onBackpackMouseDown(button, x, y)
	ISMouseDrag = {}
...
function CleanUI_Vanilla_ISInventoryPage:onBackpackClick(button)
	local playerObj = getSpecificPlayer(self.player)
	if playerObj and playerObj:getJoypadBind() ~= -1 then
...
function CleanUI_Vanilla_ISInventoryPage:onBackpackMouseUp(x, y)
...
function CleanUI_Vanilla_ISInventoryPage:onBackpackRightMouseDown(x, y)
	local page = self.parent.parent
	local container = self.inventory
	if not container then return end

    -- Cache container metadata once so virtual/stale containers cannot break the context menu.
    local parent = container:getParent()
    local containerType = container:getType()
    local isCharacterOrFloorContainer = containerType == "inventorymale" or containerType == "inventoryfemale" or containerType == "floor"
    local hasWorldObjectParent = parent and not instanceof(parent, "BaseVehicle") and not isCharacterOrFloorContainer
    local parentSquare = nil
    if hasWorldObjectParent then
        -- Some MP/virtual containers may not have a valid world object parent square.
	...
	if item then
		...
		return
    elseif hasWorldObjectParent then
        if parentSquare and SafeHouse.isSafehouseAllowInteract(parentSquare, getSpecificPlayer(page.player)) then
            context:addOption(getText("ContextMenu_RenameBag"), container, CleanUI_Vanilla_ISInventoryPage.onRenameContainer, page.player)
                ...
                if container:getSourceGrid() then
                    if isClient() then
                        ...
                        for i, v in ipairs(tItems) do
                            ISRemoveItemTool.removeItem(v, page.player)
                        end
                        ...
                        local cIndex = -1
                        for i = 0, currentParent:getContainerCount()-1 do
                            if currentParent:getContainerByIndex(i) == container then
                                cIndex = i
                            end
                        end
                        local args = { x = sq:getX(), y = sq:getY(), z = sq:getZ(), index = currentParent:getObjectIndex(), containerIndex = cIndex }
...
function CleanUI_Vanilla_ISInventoryPage:addContainerButton(container, texture, name, tooltip)
    local titleBarHeight = self:titleBarHeight()
	local playerObj = getSpecificPlayer(self.player)
	...
	if #self.buttonPool > 0 then
		...
		button = ISButton:new(x, y, self.buttonSize, self.buttonSize, "", self, CleanUI_Vanilla_ISInventoryPage.onBackpackClick, CleanUI_Vanilla_ISInventoryPage.onBackpackMouseDown, false)
	...
	button.onclick = CleanUI_Vanilla_ISInventoryPage.onBackpackClick
	button.onmousedown = CleanUI_Vanilla_ISInventoryPage.onBackpackMouseDown
	button.onMouseUp = CleanUI_Vanilla_ISInventoryPage.onBackpackMouseUp
	button.onRightMouseDown = CleanUI_Vanilla_ISInventoryPage.onBackpackRightMouseDown
	button:setOnMouseOverFunction(CleanUI_Vanilla_ISInventoryPage.onMouseOverButton)
	button:setOnMouseOutFunction(CleanUI_Vanilla_ISInventoryPage.onMouseOutButton)
...
function CleanUI_Vanilla_ISInventoryPage:checkExplored(container, playerObj)
...
function CleanUI_Vanilla_ISInventoryPage.GetFloorContainer(playerNum)
	if CleanUI_Vanilla_ISInventoryPage.floorContainer == nil then
		CleanUI_Vanilla_ISInventoryPage.floorContainer = {}
	end
	if CleanUI_Vanilla_ISInventoryPage.floorContainer[playerNum+1] == nil then
		CleanUI_Vanilla_ISInventoryPage.floorContainer[playerNum+1] = ItemContainer.new("floor", nil, nil)
		CleanUI_Vanilla_ISInventoryPage.floorContainer[playerNum+1]:setExplored(true)
	end
	return CleanUI_Vanilla_ISInventoryPage.floorContainer[playerNum+1]
end

function CleanUI_Vanilla_ISInventoryPage:refreshBackpacks()
	...
	local floorContainer = CleanUI_Vanilla_ISInventoryPage.GetFloorContainer(self.player)
	...
	elseif playerObj:getVehicle() then
		...
		for partIndex=1,vehicle:getPartCount() do
			...
			if vehiclePart:getItemContainer() and CleanUI_canAccessVehicleContainer(vehicle, partIndex-1, playerObj, vehiclePart:getItemContainer()) and vehiclePart:getId() ~= "TruckBed" then
...
-- 						containerButton = self:addContainerButton(container, nil, title, nil)
				...
				if vehicle and not vehicleContainers[vehicle] then
					...
					for partIndex=1,vehicle:getPartCount() do
						local vehiclePart = vehicle:getPartByIndex(partIndex-1)
						if vehiclePart:getItemContainer() and CleanUI_canAccessVehicleContainer(vehicle, partIndex-1, playerObj, vehiclePart:getItemContainer()) then
							local tooltip = getText("IGUI_VehiclePart" .. vehiclePart:getItemContainer():getType())
                            -- changed to include tooltips outside of the player inventory because some people want it
							containerButton = self:addContainerButton(vehiclePart:getItemContainer(), nil, tooltip, tooltip)
-- 							containerButton = self:addContainerButton(vehiclePart:getItemContainer(), nil, tooltip, nil)
...
CleanUI_Vanilla_ISInventoryPage.onRenameContainer = function(container, player)
    local title = getTextOrNull("IGUI_ContainerTitle_" .. container:getType()) or container:getType()
    if container:getCustomName() then title = container:getCustomName() end
    local modal = ISTextBox:new(0, 0, 280, 180, getText("ContextMenu_NameThisContainer"), title, nil, CleanUI_Vanilla_ISInventoryPage.onRenameContainerClick, player, getSpecificPlayer(player), container);
    modal:initialise();
...
function CleanUI_Vanilla_ISInventoryPage:onRenameContainerClick(button, player, container)
...
--************************************************************************--
--** CleanUI_Vanilla_ISInventoryPage:new
--**
--************************************************************************--
function CleanUI_Vanilla_ISInventoryPage:new (x, y, width, height, inventory, onCharacter, zoom)
	local o = {}
	--o.data = {}
    ...
    -- Use the vanilla resize icon when available, and fall back to CleanUI's bundled copy when the vanilla path is not present in the modded class copy.
    o.resizeimage = getTexture("media/ui/ResizeIcon.png") or getTexture("media/ui/CleanUI/ResizeIcon.png");
    ...
    o.visibleTarget = o;
    o.visibleFunction = CleanUI_Vanilla_ISInventoryPage.onToggleVisible;
...
function CleanUI_Vanilla_ISInventoryPage:onMouseOutButton(button,x,y)
	self.mouseOverButton = nil;
end

function CleanUI_Vanilla_ISInventoryPage:canPutIn()
    local playerObj = getSpecificPlayer(self.player)
...
function CleanUI_Vanilla_ISInventoryPage:RestoreLayout(name, layout)
...
function CleanUI_Vanilla_ISInventoryPage:SaveLayout(name, layout)
    if getJoypadData(self.player) then return end
...
CleanUI_Vanilla_ISInventoryPage.onKeyPressed = function(key)
...
CleanUI_Vanilla_ISInventoryPage.toggleInventory = function()
	if CleanUI_Vanilla_ISInventoryPage.playerInventory:getIsVisible() then
		CleanUI_Vanilla_ISInventoryPage.playerInventory:setVisible(false);
	else
		CleanUI_Vanilla_ISInventoryPage.playerInventory:setVisible(true);
	end
end

function CleanUI_Vanilla_ISInventoryPage:onInventoryContainerSizeChanged()
	local sizes = { 32, 40, 48 }
...
CleanUI_Vanilla_ISInventoryPage.ContainerSizeChanged = function()
...
CleanUI_Vanilla_ISInventoryPage.onInventoryFontChanged = function()
    for i=1,getNumActivePlayers() do
        local pdata = getPlayerData(i-1)
        if pdata then
...
CleanUI_Vanilla_ISInventoryPage.OnContainerUpdate = function(object)
    CleanUI_Vanilla_ISInventoryPage.renderDirty = true
end

CleanUI_Vanilla_ISInventoryPage.ongamestart = function()
    CleanUI_Vanilla_ISInventoryPage.renderDirty = true;
end

function CleanUI_Vanilla_ISInventoryPage:removeAll()
	self.inventoryPane:removeAll(self.player);
end

function CleanUI_Vanilla_ISInventoryPage:render3DItemPreview()
