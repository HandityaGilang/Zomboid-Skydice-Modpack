...
local face = {
	...
	icon = SPNCC_Presets.IconPresets.freckles,	--Optional, choose what texture is used for the icon in the menu
...
local bodyDetail = {
	...
	view = SPNCC_Presets.face,					--The camera settings for the preview avatar, see FM_Presets.lua

	randomExcluded = true,					--Optional, prevents this option from being picked when pressing the randomise button in character creation

	category = "Joke",						--Optional, allows server admins to hide customisation options that have a certain category

	icon = SPNCC_Presets.IconPresets.shot,		--Optional, choose what texture is used for the icon in the menu. See FM_Presets.lua
...
SPNCC_Data.AddMaleFaceData(face)
SPNCC_Data.AddFemaleFaceData(face2)
SPNCC_Data.AddBodyDetailData(bodyDetail)
SPNCC_Data.AddBodyDetailData(bodyDetail2)
