...
function FaceManager_Server.SyncBlood(player)
	...
	-- Blood/dirt sync is not a real clothing/customisation change.
	-- Only refresh the model visually, without firing another OnClothingUpdated event.
	if player and player.resetModel then
		player:resetModel()
	end
