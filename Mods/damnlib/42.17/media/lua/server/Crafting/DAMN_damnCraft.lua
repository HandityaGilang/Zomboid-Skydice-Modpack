...
function DAMN.OnCreate.MakeTirePieces(craftRecipeData, character)
    ...
    if itemType == "damnCraft.TireRubberUsedSmall" then
        localAmount = 2
    elseif itemType == "damnCraft.TireRubberNewSmall" then
        localAmount = 3
    end

    DAMN:addItemsToPlayerInventory({itemId = "Base.TirePiece", amount = localAmount,}, "DAMN.OnCreate.MakeTirePieces", character);

end

function DAMN.OnCreate.MakeTirePiecesLarge(craftRecipeData, character)
    ...
    if itemType == "damnCraft.TireRubberUsedLarge" then
        localAmount = 3
    elseif itemType == "damnCraft.TireRubberNewLarge" then
        localAmount = 4
    end
...
function DAMN.OnCreate.GunRubberCrafting(craftRecipeData, character)
    local items = craftRecipeData:getAllKeepInputItems()
