...
function DAMN.MechanicsTooltip:displayUninstallDependencies(vehicle, part, partId, option)
    return DAMN.MechanicsTooltip:displayPartDependencies(vehicle, part, partId, option, "uninstall", "requireUninstalled", "RED", "RGB:0.5,0.5,0.5", "IGUI_DL_UninstallPartsFirst");
end

function DAMN.MechanicsTooltip:displayInstallDependencies(vehicle, part, partId, option)
    return DAMN.MechanicsTooltip:displayPartDependencies(vehicle, part, partId, option, "install", "requireInstalled", "RGB:0.5,0.5,0.5", "RED", "IGUI_DL_InstallPartsFirst");
end
