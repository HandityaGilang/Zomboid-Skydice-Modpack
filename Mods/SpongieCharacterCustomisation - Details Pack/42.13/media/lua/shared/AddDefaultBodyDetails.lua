...
local camera = SPNCC_Presets.CameraPresets
local icons = SPNCC_Presets.IconPresets
	-- ----------------------
	-- -- 	BODY DETAILS
	-- ----------------------
...
for i, v in ipairs(BodyDetails) do
	SPNCC_Data.AddBodyDetailData(v)
end

table.insert(SPNCC_Data.MissingEyes, "Base.Detail_MissingEye")
