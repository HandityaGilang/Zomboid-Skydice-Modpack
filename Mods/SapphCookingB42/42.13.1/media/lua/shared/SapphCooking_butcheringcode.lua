...
--- ::---------------------------:: Chickens ::---------------------------:: ---
    ...
    table.insert(cockerelrhodeisland.parts, {item = "XXXXXX", nb = 2})
    ...
    table.insert(henleghorn.parts, {item = "XXXXXX", nb = 2})
    ...
    table.insert(cockerelleghorn.parts, {item = "XXXXXX", nb = 2})
    ...
    table.insert(lambsuffolk.parts, {item = "SapphCooking.SausageCasing", minNb = 2, maxNb = 3})
    ...
    table.insert(lambrambouillet.parts, {item = "SapphCooking.SausageCasing", minNb = 2, maxNb = 3})
    ...
    table.insert(lambfriesian.parts, {item = "SapphCooking.SausageCasing", minNb = 2, maxNb = 3})
...
--- ::---------------------------:: Cows ::---------------------------:: ---
    ...
    table.insert(cowangus.parts, {item = "SapphCooking.SausageCasing", minNb = 2, maxNb = 4})
    ...
    table.insert(cowsimmental.parts, {item = "SapphCooking.SausageCasing", minNb = 2, maxNb = 4})
    ...
    table.insert(cowholstein.parts, {item = "SapphCooking.SausageCasing", minNb = 2, maxNb = 4})
    ...
    table.insert(bullholstein.parts, {item = "SapphCooking.SausageCasing", minNb = 2, maxNb = 4})
    ...
    table.insert(bullsimmental.parts, {item = "SapphCooking.SausageCasing", minNb = 2, maxNb = 4})
    ...
    table.insert(bullangus.parts, {item = "SapphCooking.SausageCasing", minNb = 2, maxNb = 4})
...
--- ::---------------------------:: Pigs ::---------------------------:: ---
    ...
    table.insert(sowlandrace.parts, {item = "SapphCooking.SausageCasing", minNb = 2, maxNb = 3})
    ...
    table.insert(boarlandrace.parts, {item = "SapphCooking.SausageCasing", minNb = 2, maxNb = 3})
    ...
    table.insert(sowlargeblack.parts, {item = "SapphCooking.SausageCasing", minNb = 2, maxNb = 3})
    ...
    table.insert(boarlargeblack.parts, {item = "SapphCooking.SausageCasing", minNb = 2, maxNb = 3})
