...
local function ReduceUses(inventoryItem, availableUses)
    local usesFloat = inventoryItem:getCurrentUsesFloat()
    inventoryItem:setCurrentUsesFloat(usesFloat - usesFloat * availableUses)
    if inventoryItem:getCurrentUses() < 0 then inventoryItem:setCurrentUsesFloat(0.0f) end
end
