...
local function resolveLootJournalLookup(player, journalRequest)
    ...
    local exactLocalItem = request.exactJournalItem == true
        and request.b41ClientInventoryAuthority ~= true
    if not journal and not exactLocalItem and request.journalUUID and BurdJournals.findJournalByUUIDInPlayerInventory then
        journal = BurdJournals.findJournalByUUIDInPlayerInventory(player, request.journalUUID)
    end
    if not journal and not exactLocalItem and request.journalFingerprint and BurdJournals.findJournalByLookupFingerprintInPlayerInventory then
...
function BurdJournals.OpenLootJournalAction:new(character, journalRequest, actionKind, capturedJournal)
    ...
    o.journalData = o.journalRequest and o.journalRequest.journalData or nil
    o.itemFullType = o.journalRequest and o.journalRequest.itemFullType or nil
    o.b41ClientInventoryAuthority = o.journalRequest
        and o.journalRequest.b41ClientInventoryAuthority == true
        or false
...
function BurdJournals.OpenLootJournalAction:perform()
    ...
    if player and request and sendClientCommand then
        sendClientCommand(player, "BurdJournals", profile.command, {
            ...
            journalFingerprint = request.journalFingerprint,
            journalData = request.journalData,
            itemFullType = request.itemFullType,
            b41ClientInventoryAuthority = request.b41ClientInventoryAuthority == true,
