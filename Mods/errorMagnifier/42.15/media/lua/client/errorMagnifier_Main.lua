...
function errorMagnifier.MainWindow:createChildren()
    ...
    self.copyAllBtn:setImage(getTexture("media/textures/consolelogError.png"))
    ...
    self.openLogsBtn:setImage(getTexture("media/textures/consolelogErrorFolder.png"))
    ...
    self.clearBtn:setImage(getTexture("media/textures/consolelogClear.png"))
...
function errorMagnifier.doDrawItem(self, y, item, alt)
    ...
    local clipTexture = getTexture("media/textures/clipboardError.png")
    if clipTexture then
    ...
    if data.isError then
        ...
        self:setStencilRect(4, y+4, rowWidth-76, rowHeight-12)
            ...
            if x >= btnX and x <= btnX + btnSize and mouseYScrollAdjusted >= btnY and mouseYScrollAdjusted <= btnY + btnSize then
                ...
                if data then
                    ...
                    elseif data.modId and data.modId ~= "help" then
                        ...
                        textToCopy = nil  -- Don't copy for "help" placeholder
                    end
...
function errorMagnifier.showMainWindow()
    ...
    -- Build mod ID cache when window opens
    errorMagnifier.buildModIdCache()
...
function errorMagnifier.hideErrorMag()
    ...
    if errorMagnifier.Button and (MainScreen.instance and MainScreen.instance.inGame == true) then
...
function errorMagnifier.setErrorMagnifierButton()
    ...
    errorMagnifier.Button = errorMagnifier.Button or ISButton:new(x, y + 16, 22, 22, "", nil, errorMagnifier.EMButtonOnClick)
