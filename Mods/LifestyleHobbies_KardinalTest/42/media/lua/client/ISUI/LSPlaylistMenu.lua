...
if LSKHasActiveMod('truemusic') or LSKHasActiveMod('truemusic[RF6]') then
    LSKOptionalRequire("TCMusicDefenitions")
end
...
function LSPlaylistMenu:initialise()
   ...
   -- self.AMScrollList:addScrollBars();
    ...
    if not LSKHasActiveMod('truemusic') and not LSKHasActiveMod('truemusic[RF6]') and not GlobalMusic then
    ...
    self.LSMirrorFilterImage:instantiate()
