...
LSSitCheckContextMenu.doBuildMenu = function(player, context, worldobjects, Object, spriteName, customName, groupName, DebugBuildOption, AttachedObject)
    ...
    if firstSprite then 
        sendClientCommand("LSK", "ModifySprite", {{Object:getX(),Object:getY(),Object:getZ(),spriteName}, firstSprite, false, true})
    end

    if secondObject and secondSprite then 
        sendClientCommand("LSK", "ModifySprite", {{secondObject:getX(),secondObject:getY(),secondObject:getZ(),customName}, secondSprite, false, true})
    end
