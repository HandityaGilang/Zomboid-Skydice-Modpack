...
local function applyBoredom(_player, _amount, _isSet)
    if _player:getStats() ~= nil then
        ...
        elseif _player:hasTrait(CharacterTrait.COUCHPOTATO) then
            _amount = _amount*10            
        elseif _player:hasTrait(CharacterTrait.DISCIPLINED) then
            _amount = _amount*2
        else
                        ...
                        if recipe then
                            ...
                            if learned then
                                ...
                                if index then
                                    ...
                                    HaloTextHelper.addGoodText(player, LSKFormatText("IGUI_HaloNote_LearnedRecipe", getRecipeDisplayName(tostring(recipe))));
--                                     HaloTextHelper.addText(player, LSKFormatText("IGUI_HaloNote_LearnedRecipe", getRecipeDisplayName(tostring(recipe))), HaloTextHelper.getColorGreen());
                                    --self.addHalo("Learned "..tostring(string.sub(recipe, index+1, recipe:len())));
                                else
                                    HaloTextHelper.addGoodText(player, LSKFormatText("IGUI_HaloNote_LearnedRecipe", getRecipeDisplayName(recipe)));
--                                     HaloTextHelper.addText(player, LSKFormatText("IGUI_HaloNote_LearnedRecipe", getRecipeDisplayName(recipe)), HaloTextHelper.getColorGreen());
