...
function JukeboxOff:perform()
    ...
    if isClient() then
    sendClientCommand("LSK", "TurnJukeboxOff", {x, y, z})
    else
    ...
    --sendClientCommand(playerObj, "LSK", "IsTurningJukeboxOff", {JukeboxID})
...
function JukeboxOff:getDuration()
