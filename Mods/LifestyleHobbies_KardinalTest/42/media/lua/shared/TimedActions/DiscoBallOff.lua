...
function DiscoBallOff:perform()
    ...
    sendClientCommand("LSK", "TurnDiscoBallOff", {playerDiscoCommand, x, y, z})
    ...
    --sendClientCommand(playerObj, "LSK", "IsTurningDiscoBallOff", {DiscoBallID})
...
function DiscoBallOff:complete()
    return true
end

function DiscoBallOff:getDuration()
