...
Events.OnInitGlobalModData.Add(function()
    ...
    if SandboxVars.SchoolsOut.SpawnChanceToggle then
        ...
        addToDistroTable(SuburbsDistributions["Bag_BigHikingBag"].items, "seifuku.Cute_Hoodie", 0.05)

        addToDistroTable(SuburbsDistributions["Bag_NormalHikingBag"].items, "seifuku.Cute_Hoodie", 0.05)

        distributeGymUniform(SuburbsDistributions["Bag_DuffelBag"].items, 2, 1)
        addToDistroTable(SuburbsDistributions["Bag_DuffelBag"].items, "seifuku.Cute_Hoodie", 0.05)

        distributeGymUniform(SuburbsDistributions["Bag_DuffelBagTINT"].items, 2, 1)
        addToDistroTable(SuburbsDistributions["Bag_DuffelBagTINT"].items, "seifuku.Cute_Hoodie", 0.05)
