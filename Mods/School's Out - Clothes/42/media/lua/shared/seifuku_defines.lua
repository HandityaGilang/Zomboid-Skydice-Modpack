Events.OnInitGlobalModData.Add(function()
    seifuku = {
        ...
        outfit = {
            ...
            sailor = {
                items = {
                    "seifuku.FemaleUniform_Shirt", -- Shirts go here because, for item-spawning purposes, it is stored in the same containers and should appear w/ same chance as a sailor suit.
                    "seifuku.FemaleUniform_ShirtShort",
                    "seifuku.FemaleUniform_SailorWhiteBlack",
                    "seifuku.FemaleUniform_SailorShortWhiteBlack",
                    "seifuku.FemaleUniform_SailorWhiteBlue",
                    "seifuku.FemaleUniform_SailorShortWhiteBlue",
            ...
            blazer = {
                items = {
                    ...
                    "seifuku.FemaleUniform_Blazer3ButtonBlackWhite",
                    "seifuku.FemaleUniform_Blazer3ButtonBlackWhiteCrest",
                    "seifuku.FemaleUniform_Blazer2ButtonBlackWhite",
                    "seifuku.FemaleUniform_Blazer2ButtonBlackWhiteCrest",
            ...
            skirt = {
                items = {
                    ...
                    "seifuku.FemaleUniform_SkirtBlack",
                    "seifuku.FemaleUniform_SkirtBlackLong",
                    "seifuku.FemaleUniform_SkirtBlue",
                    "seifuku.FemaleUniform_SkirtBlueLong",
                },
                colors = {
                    "Black",
                    "Blue"
            ...
            socks = {
                items = {
                    "seifuku.Socks_KneeHighBlack",
                    "seifuku.Socks_KneeHighWhite",
                    "seifuku.Socks_OverKneeBlack",
                    "seifuku.Socks_OverKneeWhite",
                    "seifuku.Socks_CrewWhite",
                },
            },
            swimsuitItems = {
                str_sukumizu_item = "seifuku.FemaleUniform_Sukumizu",
                str_sukumizu_alt_color = "seifuku.FemaleUniform_SukumizuWhite",
                str_sukumizu_alt_type = "seifuku.FemaleUniform_SukumizuNewType",
                str_sukumizu_alt_type_alt_color = "seifuku.FemaleUniform_SukumizuWhiteNewType",
                str_sukumizu_comp = "seifuku.FemaleUniform_SukumizuComp",
                str_sukumizu_comp_alt_color = "seifuku.FemaleUniform_SukumizuWhiteComp"
            },
        },
        ribbon = {
            styles = {
            ...
            items = {
                ...
                "seifuku.Tie_TriangleButterflyWhite",
                ...
                "seifuku.Tie_TriangleSmallWhite",
        ...
        cute = {
            items = {
                collars = {
                    "seifuku.Cute_CollarBlack",
                    "seifuku.Cute_CollarBlue",
                    "seifuku.Cute_CollarRed"
                },
                stockings = {
        ...
        distributeCuteClothes = function(tbl_container_items, int_mask_chance, int_collar_chance, int_stocking_chance, int_hoodie_chance, int_gura_chance)
            ...
            if int_mask_chance ~= 0 then
                addToDistroTable(tbl_container_items, "seifuku.Cute_Facemask", int_mask_chance)
            end
            ...
            if int_hoodie_chance ~= 0 then
                addToDistroTable(tbl_container_items, "seifuku.Cute_Hoodie", int_hoodie_chance)
            end
            if int_gura_chance ~= 0 then
                addToDistroTable(tbl_container_items, "seifuku.Cute_PonchoGura", int_gura_chance)
            end
        end,
            ...
            if int_blazer_chance ~= 0 or int_gakuran_chance ~= 0 then
                ...
                if int_gakuran_chance ~= 0 then
                    ...
                    if Sandbox_SeifukuStyle == 3 then -- Gakuran are the male uniform style, so spawn gakuran. No problem!
                        addToDistroTable(tbl_container_items, "seifuku.MaleUniform_Gakuran", int_gakuran_chance)
                        ...
                        addToDistroTable(tbl_container_items, "seifuku.MaleUniform_Gakuran", int_gakuran_chance / (int_blazer_items + 1))
        ...
        distributeTies = function(tbl_container_items, int_base_tie_chance)
            ...
            local function insertTiesIntoTable(listOfRibbonsToSpawn)
                ...
                for _, str_color in pairs(seifuku.ribbon.colors) do
                    str_tie_item_name = "seifuku.TriangleTie" .. str_color
        ...
        distributeGymUniform = function(tbl_container_items, int_shirt_chance, int_pants_chance)
            ...
            if int_shirt_chance ~= 0 then
                if Sandbox_GymUniformStyle == 1 then
                    addToTable("seifuku.GymUniform_Shirt", int_shirt_chance / int_gymItemDivisorDefault)
                    addToTable("seifuku.GymUniform_PoloShirt", int_shirt_chance / int_gymItemDivisorDefaultHasAlt)
                    addToTable("seifuku.GymUniform_PoloShirtShort", int_shirt_chance / int_gymItemDivisorDefaultHasAlt)
                    addToTable("seifuku.GymUniform_TracksuitTopRed", int_shirt_chance / int_gymItemDivisorDefaultHasAlt)
                    addToTable("seifuku.GymUniform_TracksuitTopBlue", int_shirt_chance / int_gymItemDivisorDefaultHasAlt)
                elseif Sandbox_GymUniformStyle == 2 then
                    addToTable("seifuku.GymUniform_Shirt", int_shirt_chance)
                    addToTable("seifuku.GymUniform_PoloShirt", int_shirt_chance / int_gymItemDivisorDefault)
                    addToTable("seifuku.GymUniform_PoloShirtShort", int_shirt_chance / int_gymItemDivisorDefault)
                    addToTable("seifuku.GymUniform_TracksuitTopRed", int_shirt_chance / int_gymItemDivisorDefaultHasAlt)
                    addToTable("seifuku.GymUniform_TracksuitTopBlue", int_shirt_chance / int_gymItemDivisorDefaultHasAlt)
                elseif Sandbox_GymUniformStyle == 3 then
                    addToTable("seifuku.GymUniform_Shirt", int_shirt_chance / int_gymItemDivisorDefault)
                    addToTable("seifuku.GymUniform_PoloShirt", int_shirt_chance / int_gymItemDivisorSelectedHasAlt)
                    addToTable("seifuku.GymUniform_PoloShirtShort", int_shirt_chance / int_gymItemDivisorSelectedHasAlt)
                    addToTable("seifuku.GymUniform_TracksuitTopRed", int_shirt_chance / int_gymItemDivisorDefaultHasAlt)
                    addToTable("seifuku.GymUniform_TracksuitTopBlue", int_shirt_chance / int_gymItemDivisorDefaultHasAlt)
                else
                    addToTable("seifuku.GymUniform_Shirt", int_shirt_chance / int_gymItemDivisorDefault)
                    addToTable("seifuku.GymUniform_PoloShirt", int_shirt_chance / int_gymItemDivisorDefault)
                    addToTable("seifuku.GymUniform_PoloShirtShort", int_shirt_chance / int_gymItemDivisorDefault)
                    addToTable("seifuku.GymUniform_TracksuitTopRed", int_shirt_chance / int_gymItemDivisorSelectedHasAlt)
                    addToTable("seifuku.GymUniform_TracksuitTopBlue", int_shirt_chance / int_gymItemDivisorSelectedHasAlt)
                end
            end

            if int_pants_chance ~= 0 then
                if Sandbox_GymUniformStyle == 1 then
                    addToTable("seifuku.GymUniform_Shorts", int_pants_chance / int_gymItemDivisorDefaultHasAlt)
                    addToTable("seifuku.GymUniform_Bloomers", int_pants_chance / int_gymItemDivisorDefaultHasAlt)
                    addToTable("seifuku.FemaleUniform_SkirtWhiteShort", int_pants_chance / int_gymItemDivisorDefault)
                    addToTable("seifuku.GymUniform_TracksuitPantsRed", int_pants_chance / int_gymItemDivisorDefaultHasAlt)
                    addToTable("seifuku.GymUniform_TracksuitPantsBlue", int_pants_chance / int_gymItemDivisorDefaultHasAlt)
                elseif Sandbox_GymUniformStyle == 2 then
                    addToTable("seifuku.GymUniform_Shorts", int_pants_chance / int_gymItemDivisorSelectedHasAlt)
                    addToTable("seifuku.GymUniform_Bloomers", int_pants_chance / int_gymItemDivisorSelectedHasAlt)
                    addToTable("seifuku.FemaleUniform_SkirtWhiteShort", int_pants_chance / int_gymItemDivisorDefault)
                    addToTable("seifuku.GymUniform_TracksuitPantsRed", int_pants_chance / int_gymItemDivisorDefaultHasAlt)
                    addToTable("seifuku.GymUniform_TracksuitPantsBlue", int_pants_chance / int_gymItemDivisorDefaultHasAlt)
                elseif Sandbox_GymUniformStyle == 3 then
                    addToTable("seifuku.GymUniform_Shorts", int_pants_chance / int_gymItemDivisorSelectedHasAlt)
                    addToTable("seifuku.GymUniform_Bloomers", int_pants_chance / int_gymItemDivisorDefault)
                    addToTable("seifuku.FemaleUniform_SkirtWhiteShort", int_pants_chance / int_gymItemDivisorSelectedHasAlt)
                    addToTable("seifuku.GymUniform_TracksuitPantsRed", int_pants_chance / int_gymItemDivisorDefaultHasAlt)
                    addToTable("seifuku.GymUniform_TracksuitPantsBlue", int_pants_chance / int_gymItemDivisorDefaultHasAlt)
                else
                    addToTable("seifuku.GymUniform_Shorts", int_pants_chance / int_gymItemDivisorDefaultHasAlt)
                    addToTable("seifuku.GymUniform_Bloomers", int_pants_chance / int_gymItemDivisorDefaultHasAlt)
                    addToTable("seifuku.FemaleUniform_SkirtWhiteShort", int_pants_chance / int_gymItemDivisorDefault)
                    addToTable("seifuku.GymUniform_TracksuitPantsRed", int_pants_chance / int_gymItemDivisorSelectedHasAlt)
                    addToTable("seifuku.GymUniform_TracksuitPantsBlue", int_pants_chance / int_gymItemDivisorSelectedHasAlt)
                end
            end
        end,
        distributeSwimsuits = function(tbl_container_items, int_standard_chance, int_comp_chance, int_alt_color_divisor, int_alt_type_divisor)
            ...
            if int_standard_chance ~= 0 then
                ...
                addToDistroTable(tbl_container_items, "seifuku.MaleUniform_Sukumizu", int_standard_chance)
            end
            ...
            addToDistroTable(tbl_container_items, "seifuku.FemaleUniform_Rashguard", int_standard_chance / 5)

        end,
        distributeShoes = function(tbl_container_items, int_loafers_chance, int_uwabaki_chance)
            local addToDistroTable = seifuku.addToDistroTable
            if int_loafers_chance ~= 0 then
                addToDistroTable(tbl_container_items, "seifuku.Shoes_Loafers", int_loafers_chance)
            end
            if int_uwabaki_chance ~= 0 then
                addToDistroTable(tbl_container_items, "seifuku.Shoes_Uwabaki", int_uwabaki_chance)
            end
        end
    }
end)