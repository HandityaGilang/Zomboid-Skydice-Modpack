...
Events.OnInitGlobalModData.Add(function()
    ...
    if SandboxVars.SchoolsOut.SpawnChanceToggle then
        ...
        addToDistroTable(ProceduralDistributions.list["StripClubDressers"].items, "Base.FemaleUniform_SailorShortWhiteBlack", 0.2)
        addToDistroTable(ProceduralDistributions.list["StripClubDressers"].items, "Base.FemaleUniform_SkirtBlackShort", 0.2)
        addToDistroTable(ProceduralDistributions.list["StripClubDressers"].items, "Base.Socks_KneeHighBlack", 4)
        addToDistroTable(ProceduralDistributions.list["StripClubDressers"].items, "Base.Socks_KneeHighWhite", 4)
        addToDistroTable(ProceduralDistributions.list["StripClubDressers"].items, "Base.Socks_OverKneeBlack", 4)
        addToDistroTable(ProceduralDistributions.list["StripClubDressers"].items, "Base.Socks_OverKneeWhite", 4)
        ...
        addToDistroTable(ProceduralDistributions.list["ClothingStorageAllJackets"].items, "Base.Cute_Hoodie", 2)
        ...
        addToDistroTable(ProceduralDistributions.list["ClothingStorageAllShirts"].items, "Base.GymUniform_Shirt", 6)
        ...
        addToDistroTable(ProceduralDistributions.list["ClothingStoresJackets"].items, "Base.GymUniform_TracksuitTopRed", 4)
        addToDistroTable(ProceduralDistributions.list["ClothingStoresJackets"].items, "Base.GymUniform_TracksuitTopBlue", 4)

        distributeSchoolUniform(ProceduralDistributions.list['ClothingStoresJacketsFormal'].items, 6, 0, 0, 6, 0)

        addToDistroTable(ProceduralDistributions.list["ClothingStoresJumpers"].items, "Base.Cute_Hoodie", 2)
        distributeSweaters(ProceduralDistributions.list['ClothingStoresJumpers'].items, 4)

        addToDistroTable(ProceduralDistributions.list["ClothingStoresPants"].items, "Base.GymUniform_TracksuitPantsRed", 4)
        addToDistroTable(ProceduralDistributions.list["ClothingStoresPants"].items, "Base.GymUniform_TracksuitPantsBlue", 4)

        addToDistroTable(ProceduralDistributions.list["ClothingStoresPantsFormal"].items, "Base.MaleUniform_Trousers", 6)

        addToDistroTable(ProceduralDistributions.list["ClothingStoresShirts"].items, "Base.GymUniform_Shirt", 6)
        ...
        addToDistroTable(ProceduralDistributions.list["ClothingStoresUnderwearWoman"].items, "Base.Socks_KneeHighBlack", 4)
        addToDistroTable(ProceduralDistributions.list["ClothingStoresUnderwearWoman"].items, "Base.Socks_KneeHighWhite", 4)
        addToDistroTable(ProceduralDistributions.list["ClothingStoresUnderwearWoman"].items, "Base.Socks_OverKneeBlack", 4)
        addToDistroTable(ProceduralDistributions.list["ClothingStoresUnderwearWoman"].items, "Base.Socks_OverKneeWhite", 4)

        addToDistroTable(ProceduralDistributions.list["LingerieStoreOutfits"].items, "Base.FemaleUniform_SkirtBlackShort", 4)

        distributeCuteClothes(ProceduralDistributions.list['LingerieStoreUnderwear'].items, 0, 0, 8, 0, 0)
        addToDistroTable(ProceduralDistributions.list["LingerieStoreUnderwear"].items, "Base.Socks_KneeHighBlack", 10)
        addToDistroTable(ProceduralDistributions.list["LingerieStoreUnderwear"].items, "Base.Socks_KneeHighWhite", 10)
        addToDistroTable(ProceduralDistributions.list["LingerieStoreUnderwear"].items, "Base.Socks_OverKneeBlack", 10)
        addToDistroTable(ProceduralDistributions.list["LingerieStoreUnderwear"].items, "Base.Socks_OverKneeWhite", 10)

        addToDistroTable(ProceduralDistributions.list["SportStoreGolf"].items, "Base.GymUniform_PoloShirt", 10)
        addToDistroTable(ProceduralDistributions.list["SportStoreGolf"].items, "Base.GymUniform_PoloShirtShort", 10)

        addToDistroTable(ProceduralDistributions.list["SportStoreTennis"].items, "Base.GymUniform_PoloShirt", 10)
        addToDistroTable(ProceduralDistributions.list["SportStoreTennis"].items, "Base.GymUniform_PoloShirtShort", 10)

        addToDistroTable(ProceduralDistributions.list["SportStoreBadminton"].items, "Base.GymUniform_PoloShirt", 10)
        addToDistroTable(ProceduralDistributions.list["SportStoreBadminton"].items, "Base.GymUniform_PoloShirtShort", 10)
        ...
        addToDistroTable(ProceduralDistributions.list["CrateClothesRandom"].items, "Base.Cute_Hoodie", 0.5)
        ...
        addToDistroTable(ProceduralDistributions.list["Gifts"].items, "Base.FemaleUniform_SailorShortWhiteBlack", 4)

        -- Laundry

        distributeGymUniform(ProceduralDistributions.list['GymLaundry'].items, 2, 2)

        addToDistroTable(ProceduralDistributions.list["LaundryLoad3"].items, "Base.MaleUniform_Trousers", 4)

        addToDistroTable(ProceduralDistributions.list["LaundryLoad4"].items, "Base.GymUniform_Shirt", 10)
        ...
        addToDistroTable(ProceduralDistributions.list["LaundryLoad7"].items, "Base.GymUniform_Shirt", 10)
        distributeSocks(ProceduralDistributions.list['LaundryLoad7'].items, 5)

        addToDistroTable(ProceduralDistributions.list["LaundryLoad8"].items, "Base.GymUniform_Bloomers", 0.8)
