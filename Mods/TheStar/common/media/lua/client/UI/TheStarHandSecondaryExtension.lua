...
local function initUI()
  if ISEquippedItem.instance then
      ...
      if not handSecondaryExtensionUI then
          if Verbose then print("Warning: handSecondaryExtensionUI is nil after initUI()") end
      end
  else
      if Verbose then print("Warning: ISEquippedItem.instance is nil in initUI()") end
  end
end
...
local function hideUI()
    if handSecondaryExtensionUI then
        ...
        if Verbose then print("Warning: handSecondaryExtensionUI is nil in hideUI()") end
    end
end
...
local function checkBattery(player, item)
  if item and TheStar.Utils.isLightSource(item) and player:isLocalPlayer() then
      ...
      if handSecondaryExtensionUI then
          ...
          if Verbose then print("Warning: handSecondaryExtensionUI is nil in checkBattery()") end
      end
  end
end
...
local function onEquipSecondary(player, item)
  ...
  if handSecondaryExtensionUI then
      ...
      if Verbose then print("Warning: handSecondaryExtensionUI is nil in onEquipSecondary()") end
  end
