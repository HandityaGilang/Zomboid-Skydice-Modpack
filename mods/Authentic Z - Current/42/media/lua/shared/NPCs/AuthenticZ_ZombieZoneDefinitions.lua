...
ZombiesZoneDefinition.Nightclub = {
	...
	AuthenticSmoothCriminal = {
		name="AuthenticSmoothCriminal",
		chance=2,
		gender="male",
	},
	AuthenticFreshPrinceBelAir = {
...
ZombiesZoneDefinition.Western = {
	...
	AuthenticFat02CowGirl = {
		name="AuthenticFat02CowGirl",
		gender="female",		
		chance=5,
	},	
...
local AuthenticBathrobe1 = {
		name="AuthenticBathrobe",
		gender="female",		
		chance=5,
	};
ZombiesZoneDefinition.Spa[AuthenticBathrobe1] = AuthenticBathrobe1;

local AuthenticBathrobe2 = {
		name="AuthenticBathrobe",
		gender="female",		
		chance=5,
	};
ZombiesZoneDefinition.FancyHotel[AuthenticBathrobe2] = AuthenticBathrobe2;
...
local AuthenticFat02CowGirl = {
		name="AuthenticFat02CowGirl",
		gender="female",			
		chance=5,
	};
ZombiesZoneDefinition.Farm[AuthenticFat02CowGirl] = AuthenticFat02CowGirl;


local AuthenticFat02Cook = {
		name="AuthenticFat02Cook",
		gender="male",			
		chance=4,
		room="restaurantkitchen",		
	};
ZombiesZoneDefinition.PileOCrepe[AuthenticFat02Cook] = AuthenticFat02Cook;
ZombiesZoneDefinition.Restaurant[AuthenticFat02Cook] = AuthenticFat02Cook;

local AuthenticFat02Cook2 = {
		name="AuthenticFat02Cook",
		gender="male",			
		chance=4,
		room="spiffoskitchen",		
	};
ZombiesZoneDefinition.Spiffo[AuthenticFat02Cook2] = AuthenticFat02Cook2;
...
local AuthenticThin01School = {
		name="AuthenticThin01School",
		chance=4,
		gender="male",
	};
...
table.insert(ZombiesZoneDefinition.Default,{name = "AuthenticKate", chance=0.0009, gender="female"});
...
table.insert(ZombiesZoneDefinition.Default,{name = "AuthenticBathrobe", chance=5, room="bathroom", gender="female"});
...
table.insert(ZombiesZoneDefinition.Default,{name = "AuthenticJogger", chance=25, room="gym"});
table.insert(ZombiesZoneDefinition.Default,{name = "AuthenticJogger", chance=25, room="fitness"});
...
table.insert(ZombiesZoneDefinition.Default,{name = "AuthenticThin01School", chance=3, room="classroom", gender="male"});
...
table.insert(ZombiesZoneDefinition.Default,{name = "AuthenticFat03Blart", chance=1, room="departmentstore", gender="male"});
...
-------------------------- Fat Zombies -------------------------- 
table.insert(ZombiesZoneDefinition.Default,{name = "AuthenticFat01", chance=0.11,});
table.insert(ZombiesZoneDefinition.Default,{name = "AuthenticFat01Fisherman", chance=0.11, gender="male"});
table.insert(ZombiesZoneDefinition.Default,{name = "AuthenticFat01Dress", chance=0.11, gender="female"});
table.insert(ZombiesZoneDefinition.Default,{name = "AuthenticFat02", chance=0.11,});
table.insert(ZombiesZoneDefinition.Default,{name = "AuthenticFat02Cook", chance=0.06, gender="male"});
table.insert(ZombiesZoneDefinition.Default,{name = "AuthenticFat02Dress", chance=0.11, gender="female"});
table.insert(ZombiesZoneDefinition.Default,{name = "AuthenticFat02CowGirl", chance=0.05, gender="female"});
table.insert(ZombiesZoneDefinition.Default,{name = "AuthenticFat03", chance=0.11,});
table.insert(ZombiesZoneDefinition.Default,{name = "AuthenticFat03Dress", chance=0.11, gender="female"});
table.insert(ZombiesZoneDefinition.Default,{name = "AuthenticThin01", chance=0.11, gender="male"});
table.insert(ZombiesZoneDefinition.Default,{name = "AuthenticThin01PJ", chance=0.06, gender="male"});
table.insert(ZombiesZoneDefinition.Default,{name = "AuthenticThin01Overalls", chance=0.08, gender="male"});
table.insert(ZombiesZoneDefinition.Default,{name = "AuthenticThin01School", chance=0.07, gender="male"});