...
local ALICE_ClothingDistribution = {
    Trapper = {
        ...
        {"ALICE.AliceCanteenFull", 0.02},
        {"ALICE.AliceCanteenEmpty", 0.02},
    ...
    SurvivalGear = {
        {"ALICE.AliceVest2PTight", 0.02},
        {"ALICE.AliceCanteenFull", 2},
        {"ALICE.AliceCanteenEmpty", 2},
    ...
    CampingStoreClothes = {
        ...
        {"ALICE.AliceBackpack", 2},
        {"ALICE.AliceFieldpack", 2},
        {"ALICE.GasMaskPouchOverShoulder", 1},
        {"ALICE.GasMaskDoff", 1},
    ...
    CrateRandomJunk = {
        ...
        {"ALICE.AliceCanteenFull", 0.004},
        {"ALICE.AliceCanteenEmpty", 0.003},
    ...
    Hunter = {
        ...
        {"ALICE.AliceCanteenFull", 0.5},
        {"ALICE.AliceCanteenEmpty", 0.5},
    ...
    LockerArmyBedroom = {
        ...
        {"ALICE.M9BayonetSheath", 2},
        {"ALICE.M9Bayonet", 2},
        {"ALICE.AliceBackpack", 0.1},
        {"ALICE.AliceFieldpack", 0.1},
