...
if getActivatedMods():contains('truemusic') or getActivatedMods():contains('truemusic[RF6]') then
...
function LSPlaylistMenu:initialise()
   ...
   -- self.AMScrollList:addScrollBars();
	...
	if not getActivatedMods():contains('truemusic') and not getActivatedMods():contains('truemusic[RF6]') and not GlobalMusic then
