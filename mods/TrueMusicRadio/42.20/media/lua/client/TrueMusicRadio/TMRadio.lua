...
TMRadio.whereAreYou = function(device, index)
	...
	if deviceData.isVehicleDevice and deviceData:isVehicleDevice() and deviceData:getParent() and 
	   deviceData:getParent():getVehicle() and deviceData:getParent():getVehicle():getX() then
	...
	if not x and device.isInPlayerInventory and device:isInPlayerInventory() and getPlayer() and getPlayer():getX() then
		x = getPlayer():getX()
		y = getPlayer():getY()
		z = getPlayer():getZ()
	...
	if not x and device.getSquare and device:getSquare() and device:getX() then
		x = device:getX()
		y = device:getY()
		z = device:getZ()
		--print("location from self - has square uses direct getx")
	end
	if not x and device.getSquare and device:getSquare() and device:getSquare():getX() then
	...
	if not x and deviceData:isInventoryDevice() then
		if device.getContainer and device:getContainer() and device.getOutermostContainer and device:getOutermostContainer() then
			if device:getOutermostContainer():isVehiclePart() and device:getOutermostContainer():getVehicle() and device:getOutermostContainer():getVehicle():getX() then
			...
			elseif device:getOutermostContainer():isCorpse() and device:getOutermostContainer():getSquare() and device:getOutermostContainer():getSquare():getX() then
