...
table.insert(ZombiesZoneDefinition.Default,{name = "AuthenticFat03Dress", chance=0.1, gender="female"});
table.insert(ZombiesZoneDefinition.Default,{name = "AuthenticThin01", chance=0.1, gender="male"});
