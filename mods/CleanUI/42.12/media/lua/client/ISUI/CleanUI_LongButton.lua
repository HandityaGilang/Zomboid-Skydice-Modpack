...
function CleanUI_LongButton:prerender()
    ...
    -- Border
    CleanUI.ThreePatch.drawHorizontal(self, 0, 0, self.width, self.height, self.buttonBorder.L, self.buttonBorder.M, self.buttonBorder.R, 1, self.borderColor.r, self.borderColor.g, self.borderColor.b)
