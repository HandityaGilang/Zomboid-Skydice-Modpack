...
function ContextMenu.onFillWorldContext(playerIdx, context, worldObjects, test)
    ...
    if worldObj then
        ...
        local windowSubMenu = context:getOptionFromName(getText("ContextMenu_Window")) and context:getSubMenu(context:getOptionFromName(getText("ContextMenu_Window")).subOption)
        local doorSubMenu = context:getOptionFromName(getText("ContextMenu_Door_option")) and context:getSubMenu(context:getOptionFromName(getText("ContextMenu_Door_option")).subOption)
