local TABAS_ModOptions = {
    ...
    options = {
        ...
        DropEquippedItemsContainer = nil,
...
function TABAS_ModOptions:createOptions()
    ...
    self.options.DropEquippedItemsContainer = options:addTickBox(
        "DropEquippedItemsContainer",
        getText("UI_TABAS_DropEquippedItemsContainer"),
        true,
        getText("UI_TABAS_DropEquippedItemsContainer_tooltip")
    )
