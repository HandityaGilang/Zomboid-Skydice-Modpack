...
function TABAS_ContextMenuBathtub.createMenu(player, bathObj, context, worldObjects, test)
    ...
    if TABAS_MenuOnTakeBath.isTakingBath(player) then
        TABAS_MenuOnTakeBath.createMenuOnTakeBath(player, faucetObj, tubObj, tfc_Base, worldObjects, test, subMenu)
        return
    end
...
local function TABAS_CreateContextMenu(player, context, worldObjects, test)
    ...
    if type == "Bathtub" then
        TABAS_ContextMenuBathtub.createMenu(player, object, context, worldObjects, test)
    elseif type == "Shower" then
        TABAS_ShowerMenu.createMenu(player, object, context, worldObjects, test)
    end
end
