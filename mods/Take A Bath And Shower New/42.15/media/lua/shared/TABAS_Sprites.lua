...
TABAS_Sprites.WITH_SHOWER = {
    ["Large Deluxe"] = true,
    ["Large Deluxe Clean"] = true,
}
...
TABAS_Sprites.Shower = {
    ["Deluxe"] = {spriteS = "fixtures_bathroom_01_32", spriteE = "fixtures_bathroom_01_33"},
    ["Improved Deluxe"] = {spriteS = "tabas_fixtures_bathroom_01_32", spriteE = "tabas_fixtures_bathroom_01_33", spriteN = "tabas_fixtures_bathroom_01_34", spriteW = "tabas_fixtures_bathroom_01_35"},
    ["Wall"] = {spriteS = "fixtures_bathroom_01_30", spriteE = "fixtures_bathroom_01_31", spriteN = "fixtures_bathroom_01_22", spriteW = "fixtures_bathroom_01_23"},
}
...
function TABAS_Sprites.buildIndexes()
    ...
    TABAS_Sprites.Index.ModelTypeBySprite = {}
            ...
            for _, dirKey in ipairs(DIR_KEYS) do
                ...
                if type(dir) == "table" then
                    if dir.faucet then
                        ...
                        if TABAS_Sprites.WITH_SHOWER[modelType] then
