...
TABAS_STubFluidContainerSystemCommand.tabas_tfc.fillFluid = function(player, args)
    ...
    tfc_Base:addFluid(fluid, tfc_Base:getCapacity(), nil, true)
    tfc_Base:setWaterTemperature(temperature)
    tfc_Base:syncWaterState(true)
