...
function TABAS_Patches.apply()
    ...
    local function excludeBodyLocation(bodyLocation)
        if bodyLocation then
            table.insert(exclude, bodyLocation)
        end
    end
    excludeBodyLocation(RasBodyModRegistries.Skin)
    excludeBodyLocation(RasBodyModRegistries.ChestHair)
    excludeBodyLocation(RasBodyModRegistries.ArmpitHair)
    excludeBodyLocation(RasBodyModRegistries.PubicHair)
    excludeBodyLocation(RasBodyModRegistries.LegHair)
    excludeBodyLocation(RasBodyModRegistries.BeardStubble)
    excludeBodyLocation(RasBodyModRegistries.HeadStubble)
    excludeBodyLocation(RasBodyModRegistries.MalePrivatePart)
