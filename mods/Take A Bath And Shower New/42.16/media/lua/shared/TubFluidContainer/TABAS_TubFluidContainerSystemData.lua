...
2) md.Activated (Runtime Operation State)
  ...
  Lifetime / Cleanup:
    - If activate becomes false, the entry is removed immediately.
    - If bath/tfc cannot be confirmed but Registered[id] still exists, the entry may remain pending until the square is loaded again.
