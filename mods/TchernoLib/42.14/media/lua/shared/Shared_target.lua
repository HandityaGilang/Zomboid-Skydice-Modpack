...
local function isBlockingMouse(square,args)
    return square and ( square:isSolid()
                    ...
                    or square:has(IsoFlagType.collideW)
                    or square:has(IsoFlagType.collideN)
                    or square:has(IsoFlagType.doorW)--TODO check for open door ?
                    or square:has(IsoFlagType.doorN)--TODO check for open door ?
                    or (not args or not args.goThroughWindow) and 
                        (square:has(IsoFlagType.WindowW)
                      or square:has(IsoFlagType.WindowN))
                    )
end
