...
lcl.ArrayList_remove = lcl.ArrayList_base.remove
...
lcl.PZArrayList_remove      = lcl.PZArrayList_base.remove
...
lcl.io_transmitCompleteItemToClients = lcl.io_base.transmitCompleteItemToClients
lcl.io_addToWorld                    = lcl.io_base.addToWorld--beware overload are not called!


lcl.pc_base = __classmetatables[PropertyContainer.class].__index
lcl.pc_has          = lcl.pc_base.has
lcl.pc_Is           = lcl.pc_has
--lcl.pc_Val          = lcl.pc_base.Val--obsolete
--lcl.pc_set          = lcl.pc_base.set--I do not know how to handle the overload choice
lcl.pc_getFlagsList = lcl.pc_base.getFlagsList

lcl.ifl_base = __classmetatables[IsoFlagType.class].__index
lcl.ifl_fromIndex = IsoFlagType.fromIndex
lcl.ifl_index     = lcl.ifl_base.index
