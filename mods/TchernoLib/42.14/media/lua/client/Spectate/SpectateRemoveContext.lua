...
local ul_ISWorldMenuElements_ContextDebugHighlights = ISWorldMenuElements and ISWorldMenuElements.ContextDebugHighlights
if ul_ISWorldMenuElements_ContextDebugHighlights then
...
local ul_ISWorldMenuElements_ContextDisassemble = ISWorldMenuElements and ISWorldMenuElements.ContextDisassemble
if ul_ISWorldMenuElements_ContextDisassemble then
...
local ul_ISWorldMenuElements_ContextTelevision = ISWorldMenuElements and ISWorldMenuElements.ContextTelevision
if ul_ISWorldMenuElements_ContextTelevision then
