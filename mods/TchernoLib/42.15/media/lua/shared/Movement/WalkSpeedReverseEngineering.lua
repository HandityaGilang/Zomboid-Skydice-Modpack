...
--lcl.tc_base            = __classmetatables[TraitCollection.class].__index -- removed 42.13.0 TODO replace by new AdrenalineJunkieEffect on speed
...
function RE.getRunSpeedModifier(inventoryItem)
    local runSpeedModifier = inventoryItem.getRunSpeedModifier ~= nil and inventoryItem:getRunSpeedModifier() or 1.0
