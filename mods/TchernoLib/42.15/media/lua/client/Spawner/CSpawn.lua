...
local ul_ISSearchManager_OnFillWorldObjectContextMenu = ISSearchManager.OnFillWorldObjectContextMenu
function ISSearchManager.OnFillWorldObjectContextMenu(player, context, worldobjects, test)
    ...
    if not override then
        ul_ISSearchManager_OnFillWorldObjectContextMenu(player, context, worldobjects, test)
    end
end
Events.OnFillWorldObjectContextMenu.Remove(ul_ISSearchManager_OnFillWorldObjectContextMenu);
