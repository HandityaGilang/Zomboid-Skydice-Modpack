...
WPIso.BuildPump = function(square, spriteName)
    local args = {
        x = square:getX(),
        y = square:getY(),
        z = square:getZ(),
    ...
    sendClientCommand(getSpecificPlayer(0), "Commands", "PumpBuild", args)
end

WPIso.IsPump = function(object)
    if not instanceof(object, "IsoClothingDryer") then return false end
...
WPIso.BuildPipe = function(square)
    ...
    sendClientCommand(getSpecificPlayer(0), "Commands", "PipeBuild", args)
