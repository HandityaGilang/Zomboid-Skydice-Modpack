...
function AegisHealthFigure:render()
    ...
    -- review finding: scaling to the full canvas stretched every mask
...
function AegisPlayerPageHealth:refresh()
    ...
    local band, disi = findMedItems(p)
...
function AegisPlayerPageHealth:drawBodyCard(x, y, w, h)
    ...
    -- review finding, the old maths let it hang into the world)
    ...
    -- otherwise sit on the text (live review finding)
