...
function AegisPageServer:createChildren()
    ...
    -- (user request), and yields downwards if the announcement card
...
-- was off by the timezone: entering 00:11 restarted at 02:11 local (user
-- finding). Falls back to the UTC parts if the global ever goes away
