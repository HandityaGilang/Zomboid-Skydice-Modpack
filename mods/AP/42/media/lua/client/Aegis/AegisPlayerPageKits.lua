...
-- the redeem strip sits at the BOTTOM of the page (user request): a fixed
...
function AegisPlayerPageKits.drawCards(panel)
    ...
    for _, kit in ipairs(page.kits) do
        ...
        -- why this kit is yours (user request): the role it came through
        ...
        if kit.why then
            ...
            -- a stub that then ran under the claim button (review finding)
