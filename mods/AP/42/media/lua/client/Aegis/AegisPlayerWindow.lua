...
AegisPlayerWindow.version = "1.2.1"
...
-- first in the sidebar (review finding); the id order below decides the
...
local function clockGear()
    ...
    -- watch shows the time for the shared screen (review finding, plain
...
function AegisPlayerWindow:prerender()
    ...
    -- guard the admin window uses (live review finding: the old two
    ...
    -- edge, long role names must not run underneath them (review finding)
