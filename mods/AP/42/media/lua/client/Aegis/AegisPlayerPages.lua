...
-- review finding: the first build used the ledger field names and every
...
-- the switch quietly vanished exactly where it mattered (user finding).
...
function AegisPlayerPageSafehouse:prerender()
    ...
    -- (user request): a click points the screen navi at the safehouse,
...
-- fresh character OUTSIDE the house (user finding, 7x16 zone). Same
