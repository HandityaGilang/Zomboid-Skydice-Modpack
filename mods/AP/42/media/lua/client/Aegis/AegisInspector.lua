...
-- interior floor behind it (user finding: shop sign showed shop floor)
...
-- the own z picked the interior behind the wall instead (user finding)
local MAX_LEVEL = 7
...
function AegisInspectorOverlay:update()
    ...
    pcall(function()
        ...
        -- hit (user finding: wall clock lost against hidden z1 walls)
