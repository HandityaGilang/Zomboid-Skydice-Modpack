...
-- for "the circle follows me" (user report) was the carry/placement
...
-- (live finding: severe fps drops), the boundary ring carries the same
...
function AegisPowerOverlay:render()
    ...
    for _, gen in ipairs(generators) do
        ...
        -- reliably shows "this is where it would supply" (user report:
