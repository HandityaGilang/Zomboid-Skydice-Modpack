...
-- the default "user" every normal player carries (live finding: a name
...
local PLAIN_LEVELS = { [""] = true, none = true, user = true, banned = true, priorityuser = true }
...
function AegisShared.levelIsAdmin(level)
    ...
    elseif readable then
        ...
        -- server side included (player report: a "Veteran" rank without
...
-- facing a different direction than the footprint showed (live test finding).
