local function EditRecipes()
    local recipeList = {
        ...
        ["OpenBottleOfBeer"] = {
            ...
            item 1 [Base.BeerBottle;Base.BeerImported;VFX.BottleAmericanLightLager;VFX.BottleAmericanLager;VFX.BottlePilsner;VFX.BottleViennaLager;VFX.BottlePaleAle;VFX.BottleAmberAle;VFX.BottlePorter;VFX.BottleStout;VFX.BottleAmericanWheatBeer;VFX.BottleHomemadeBeer] mode:keep flags[DontPutBack;IsSealed;Prop2;Unseal;ItemCount],
        ]],
            outputs = [[
            item 1 VFX.BottleCap,
        ]]
        },
        ...
        ["OpenBottleOfWine"] = {
            ...
            item 1 [Base.Wine;Base.Wine2;Base.WineAged;VFX.WineChardonnay;VFX.WineCabernetSauvignon;VFX.WineMerlot;VFX.WinePinotNoir;VFX.WineSauvignonBlanc;VFX.WinePinotGris;VFX.WineRiesling;VFX.BottleHomemadeWine] mode:keep flags[DontPutBack;IsSealed;Prop2;Unseal;ItemCount],
        ]]
        },
        ...
        ["OpenBagOfFrozenFood"] = {
            inputs = [[
            item 1 [Base.Frozen_ChickenNuggets;Base.Frozen_FishFingers;Base.Frozen_FrenchFries;Base.Frozen_TatoDots;VFX.BagHashbrowns;VFX.BagWedges;VFX.BagOnionRings;VFX.BagChickenTenders;VFX.BagMozzarellaSticks] flags[AllowFrozenItem;InheritFoodAge;InheritFreezingTime;AllowRottenItem;Prop2] mappers[foodType],
            ]]
        },

        ["OpenJarOfFood"] = {
            inputs = [[
            item 1 tags[base:preservedfood] flags[AllowRottenItem;InheritFood;ItemCount;Prop2] mappers[foodType],
            ]]
        },

        ["MillFlour"] = {
            inputs = [[
            item 12 [Base.WheatSeed],
            ]]
        },
